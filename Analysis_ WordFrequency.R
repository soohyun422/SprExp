...
spr_clean[which(substr(spr_clean$Condition,1,1) == "L"),]$Pat <- "L"
spr_clean[which(substr(spr_clean$Condition,1,1) == "H"),]$Pat <- "H"
...
lmer.reg6.2 <- lmer(ResRT ~ Condition +(1|W_Freq) +(1|WorkerID) + (1|Item) + (1|List), data=reg6)
summary(lmer.reg6.2)
...
lmer.LL.HL.reg6.3 <-lmer(ResRT ~ Patienthood*BigramF+W_Freq + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.LL.HL.reg6.3)

lmer.LL.HL.reg6.4 <-lmer(ResRT ~ Patienthood*BigramF+(1|W_Freq) + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.LL.HL.reg6.4)



r.squaredGLMM(lmer.LL.HL.reg6)
r.squaredGLMM(lmer.LL.HL.reg6.3)
r.squaredGLMM(lmer.LL.HL.reg6.4)

lmer.LL.HL.reg6.5 <- lmer(ResRT ~ Condition +(1|W_Freq) +(1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.LL.HL.reg6.5)
...
attach(lookintoReg6)
lmer.LH.HL.reg6 <- lmer(ResRT ~ Condition + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.LH.HL.reg6)

lmer.LH.HL.reg6.3 <-lmer(ResRT ~ Patienthood*BigramF+W_Freq + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.LH.HL.reg6.3)

lmer.LH.HL.reg6.4 <-lmer(ResRT ~ Patienthood*BigramF +(1|W_Freq) + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.LH.HL.reg6.4)

r.squaredGLMM(lmer.LH.HL.reg6)
r.squaredGLMM(lmer.LH.HL.reg6.3)
r.squaredGLMM(lmer.LH.HL.reg6.4)


lmer.LH.HL.reg6.5 <- lmer(ResRT ~ Condition +(1|W_Freq) +(1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.LH.HL.reg6.5)
...
attach(lookintoReg6)
lmer.HH.HL.reg6 <- lmer(ResRT ~ Condition + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.HH.HL.reg6)


lmer.HH.HL.reg6.3 <-lmer(ResRT ~ Patienthood*BigramF+W_Freq + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.HH.HL.reg6.3)

lmer.HH.HL.reg6.4 <-lmer(ResRT ~ Patienthood*BigramF+(1|W_Freq) + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.HH.HL.reg6.4)


r.squaredGLMM(lmer.HH.HL.reg6)
r.squaredGLMM(lmer.HH.HL.reg6.3)
r.squaredGLMM(lmer.HH.HL.reg6.4)


lmer.HH.HL.reg6.5 <- lmer(ResRT ~ Condition +(1|W_Freq) +(1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.HH.HL.reg6.5)
...
attach(lookintoReg6)
lmer.LL.LH.reg6 <- lmer(ResRT ~ Condition + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.LL.LH.reg6)

lmer.LL.LH.reg6.3 <-lmer(ResRT ~ Patienthood*BigramF+W_Freq + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.LL.LH.reg6.3)

lmer.LL.LH.reg6.4 <-lmer(ResRT ~ Patienthood*BigramF+(1|W_Freq) + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.LL.LH.reg6.4)

r.squaredGLMM(lmer.LL.LH.reg6)
r.squaredGLMM(lmer.LL.LH.reg6.3)
r.squaredGLMM(lmer.LL.LH.reg6.4)


lmer.LL.LH.reg6.5 <- lmer(ResRT ~ Condition +(1|W_Freq) +(1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.LL.LH.reg6.5)
...
lmer.HH.LH.reg6 <- lmer(ResRT ~ Condition + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.HH.LH.reg6)

lmer.HH.LH.reg6.3 <-lmer(ResRT ~ Patienthood*BigramF+W_Freq + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.HH.LH.reg6.3)

lmer.HH.LH.reg6.4 <-lmer(ResRT ~ Patienthood*BigramF+(1|W_Freq) + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.HH.LH.reg6.4)

r.squaredGLMM(lmer.HH.LH.reg6)
r.squaredGLMM(lmer.HH.LH.reg6.3)
r.squaredGLMM(lmer.HH.LH.reg6.4)

lmer.HH.LH.reg6.5 <- lmer(ResRT ~ Condition + (1|W_Freq) +(1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.HH.LH.reg6.5)
...
attach(lookintoReg6)
lmer.HH.LL.reg6 <- lmer(ResRT ~ Condition + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.HH.LL.reg6)

lmer.HH.LL.reg6.3 <-lmer(ResRT ~ Patienthood*BigramF+W_Freq + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.HH.LL.reg6.3)

lmer.HH.LL.reg6.4 <-lmer(ResRT ~ Patienthood*BigramF+(1|W_Freq) + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.HH.LL.reg6.4)


r.squaredGLMM(lmer.HH.LL.reg6)
r.squaredGLMM(lmer.HH.LL.reg6.3)
r.squaredGLMM(lmer.HH.LL.reg6.4)


lmer.HH.LL.reg6.5 <- lmer(ResRT ~ Condition +(1|W_Freq) +(1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.HH.LL.reg6.5)
