...
for(type in unique(data$Type)){
  ...
  spr_raw[which(spr_raw$Type==type),]$Pat<-(data[which(data$Type==type),]$Patienthood)
}
...
attach(reg6)
lmer.reg6 <- lmer(ResRT ~ Condition + (1+Condition|WorkerID) + (1+Condition|Item) + (1+Condition|List), data=reg6)
summary(lmer.reg6)

attach(reg6)
lmer.reg6 <- lmer(ResRT ~ Condition  + (1|WorkerID) + (1|Item) + (1|List) + (1|W_Freq), data=reg6)
summary(lmer.reg6)
...
attach(lookintoReg6)
lmer.LL.HLreg6 <- lmer(ResRT ~ Condition  + (1|WorkerID) + (1|Item) + (1|List) + (1|W_Freq), data=lookintoReg6)
# lmer(ResRT ~ Condition + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
...
attach(lookintoReg6)
lmer.LL.HLreg6 <- lmer(ResRT ~ Condition  + (1+Condition|WorkerID) + (1+Condition|Item) + (1|List) + (1|W_Freq), data=lookintoReg6)
#lmer(ResRT ~ Condition + (1|WorkerID) + (1|Item) + (1|List), data=lookintoReg6)
summary(lmer.LL.HLreg6)
detach(lookintoReg6)
